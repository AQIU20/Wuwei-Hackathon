...
export const dict = {
  en: {
    ...
    scenes: {
      ...
      items: [
        { src: "/智能烹饪助手.png", alt: "Smart cooking assistant with voice-guided recipe and code" },
        { src: "/沐浴语音助手.png", alt: "Voice assistant for a relaxing bath experience" },
        { src: "/睡眠健康监测.png", alt: "Sleep health monitoring with heart rate tracking" },
        { src: "/宝宝远程看护.png", alt: "Remote baby monitoring with camera alerts" },
        { src: "/情绪感知调节.png", alt: "Mood detection that adjusts music and lighting" },
        { src: "/影片智能推荐.png", alt: "Smart movie recommendation based on your vibe" },
        { src: "/语音食谱计时.png", alt: "Voice-guided recipe with timer while cooking" },
        { src: "/睡眠质量闹钟.png", alt: "Sleep quality tracking with smart alarm" },
        { src: "/氛围音乐灯光.png", alt: "Ambient music and lighting for the perfect mood" },
        { src: "/会议日程提醒.png", alt: "Meeting schedule reminders at your desk" },
        { src: "/助眠建议闹钟.png", alt: "Sleep tips and smart alarm for better rest" },
        { src: "/幼儿玩耍提醒.png", alt: "Playtime timer and nap reminder for toddlers" },
        { src: "/阳台空气质量.png", alt: "Balcony air quality monitoring while reading" },
      ],
    },
    team: {
      eyebrow: "The team",
  ...
  zh: {
    ...
    scenes: {
      ...
      title: "开箱即用的场景",
      items: [
        { src: "/智能烹饪助手.png", alt: "智能烹饪助手，语音引导菜谱" },
        { src: "/沐浴语音助手.png", alt: "沐浴语音助手，放松享受" },
        { src: "/睡眠健康监测.png", alt: "睡眠健康监测，心率追踪" },
        { src: "/宝宝远程看护.png", alt: "宝宝远程看护，摄像头即时提醒" },
        { src: "/情绪感知调节.png", alt: "情绪感知，自动调整音乐和灯光" },
        { src: "/影片智能推荐.png", alt: "根据你的状态智能推荐影片" },
        { src: "/语音食谱计时.png", alt: "语音食谱计时，做饭好帮手" },
        { src: "/睡眠质量闹钟.png", alt: "睡眠质量追踪与智能闹钟" },
        { src: "/氛围音乐灯光.png", alt: "氛围音乐灯光，打造完美心情" },
        { src: "/会议日程提醒.png", alt: "会议日程提醒，高效办公" },
        { src: "/助眠建议闹钟.png", alt: "助眠建议与智能闹钟" },
        { src: "/幼儿玩耍提醒.png", alt: "幼儿玩耍计时与午睡提醒" },
        { src: "/阳台空气质量.png", alt: "阳台空气质量监测，惬意阅读" },
      ],
    },
    team: {
      eyebrow: "团队",
