...
export const dict = {
  en: {
    ...
    scenes: {
      ...
      items: [
        { src: "/scene-cooking-new.png", alt: "Voice assistant guides you through a recipe while cooking" },
        { src: "/scene-sleeping-new.png", alt: "Sound block monitors your sleep quality" },
        { src: "/scene-baby-new.png", alt: "Camera block watches the baby and alerts you instantly" },
        { src: "/scene-mood-new.png", alt: "Sound block detects mood and adjusts music & lighting" },
  ...
  zh: {
    ...
    scenes: {
      ...
      title: "开箱即用的场景",
      items: [
        { src: "/scene-cooking-new.png", alt: "语音块在你做饭时引导你完成菜谱" },
        { src: "/scene-sleeping-new.png", alt: "声音块监测你的睡眠质量" },
        { src: "/scene-baby-new.png", alt: "摄像头块看护宝宝，即时提醒你" },
        { src: "/scene-mood-new.png", alt: "声音块感知情绪，自动调整音乐和灯光" },
